                ...
                <div class="nano">
                    <div class="nano-content">
                        <nav id="menu" class="nav-main" role="navigation">
                            ...
                            ?>
                            <?php
                                $query = $this->db->query("SELECT * FROM admin_menus WHERE status = 1 AND parent_id > 1 ORDER BY id");
                                foreach ($query->result() as $row)
                                {
                                    $title = trim($row->title);
                                    $icon = $row->icon;
                            ...
                            ?>
                                <li class="nav-parent">
                                    ...
                                    <?php
                                        $query = $this->db->query("SELECT title,icon,url FROM admin_menus WHERE status = 1 AND parent_id = $menu_id");
                                        foreach ($query->result() as $submenus)
                                        {
                                    ?>
                                        <li <?php echo $page_title == $title ? "nav-active" : ""; ?>>
                                            <a href="<?php echo site_url($submenus->url) ?>">
                                                <?php echo $submenus->title ?>
                                            </a>
                                        </li>
                                    <?php
                                        }
