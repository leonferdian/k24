            ...
            <div id="main-content" class="twelve columns">
               ...
               <div id="mc-signup">
                  ...
                  <form id="mc-form" class="group">
                     ...
                     <input type="text" value="" name="phone" class="email" id="phone" placeholder="No. Hp" required>
                     <input type="text" value="" name="birthdate" class="email" id="birthdate" placeholder="Tanggal Lahir" required>
